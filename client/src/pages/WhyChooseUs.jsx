...
import { GraduationCap, Users, Lightbulb, HeartHandshake, Trophy, Target, Compass, BookOpenCheck } from 'lucide-react';
...
export default function WhyChooseUs() {
  ...
  const features = settings.whyChooseUs?.length ? settings.whyChooseUs : DEFAULT_FEATURES;
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-navy-100 text-sm leading-relaxed">{item.description}</p>
                </div>
              </div>
            );
          })}

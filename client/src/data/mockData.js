...
export const programs = [
  {
    ...
    semesters: [
      { title: 'Semester I', courses: ['Introduction to Information Technology', 'C Programming', 'Physics', 'Mathematics I'] },
      { title: 'Semester II', courses: ['Digital Logic', 'Object Oriented Programming', 'Discrete Structures', 'Mathematics II'] },
      { title: 'Semester III', courses: ['Data Structures & Algorithms', 'Database Systems', 'Microprocessor', 'Numerical Methods'] },
      { title: 'Semester IV', courses: ['Operating Systems', 'Software Engineering', 'Computer Networks', 'Applied Statistics'] },
    ],
  ...
  },
  {
    ...
    semesters: [
      { title: 'Semester I', courses: ['Computer Fundamentals', 'English I', 'Society and Technology', 'Mathematics I'] },
      { title: 'Semester II', courses: ['C Programming', 'Digital Logic', 'Financial Accounting', 'Mathematics II'] },
      { title: 'Semester III', courses: ['Data Structures', 'System Analysis & Design', 'Statistics I', 'Web Technology'] },
      { title: 'Semester IV', courses: ['Database Management Systems', 'Software Engineering', 'Operating Systems', 'Statistics II'] },
    ],
...
export const newsEvents = [
  { id: 'e1', title: 'Swastik Byte 2026: Hackathon Finals', date: '2026-08-14', type: 'Event' },
  { id: 'e2', title: 'Alumni Homecoming & Networking Evening', date: '2026-08-02', type: 'Event' },
  { id: 'e3', title: 'Guest Lecture: Careers in Applied AI', date: '2026-07-29', type: 'Event' },
];

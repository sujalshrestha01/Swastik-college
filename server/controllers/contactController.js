...
export async function submitInquiry(req, res) {
  try {
    ...
    res
      .status(400)
      .json({ message: "Failed to submit inquiry", error: err.message });
  }
}
...
export async function markInquiryRead(req, res) {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to update inquiry", error: err.message });
  }
}
...
export async function deleteInquiry(req, res) {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to delete inquiry", error: err.message });
  }
}

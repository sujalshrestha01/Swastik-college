...
const siteSettingsSchema = new mongoose.Schema(
  {
    ...
    about: {
      timeline: {
        ...
        default: [
          { year: '2005', title: 'The Foundation', description: 'Established with a simple mission: providing accessible, world-class higher education to aspiring minds.' },
          { year: '2012', title: 'University Affiliation', description: 'Formally affiliated with Tribhuvan University, introducing nationally recognized degree programs.' },
          { year: '2018', title: 'Campus & Infrastructure Expansion', description: 'Built state-of-the-art computer labs, an extended digital library, and modern student research centers.' },
          { year: 'Present Day', title: 'Leading Academic Innovation', description: 'A thriving community of over 2,000 students, industry-leading faculty, and strong global alumni networks.' },
        ],
      },
      values: {
        type: [
        ...
        default: [
          { icon: 'GraduationCap', colorKey: 'blue', title: 'Academic Excellence', text: 'Rigorous coursework matched with real-world project applications.' },
          { icon: 'Users', colorKey: 'emerald', title: 'Expert Mentorship', text: 'Learn directly from industry experts and seasoned academic professors.' },
          { icon: 'Lightbulb', colorKey: 'amber', title: 'Innovation First', text: 'Fostering research, creative problem solving, and technological skills.' },
          { icon: 'HeartHandshake', colorKey: 'rose', title: 'Community & Ethics', text: 'Building strong values, social responsibility, and lifelong connections.' },
        ],
      },
      leadership: {
        text: {
